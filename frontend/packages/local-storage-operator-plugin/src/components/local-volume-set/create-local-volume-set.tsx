...
import { k8sCreate, referenceFor, apiVersionForModel } from '@console/internal/module/k8s';
import { ClusterServiceVersionModel } from '@console/operator-lifecycle-manager';
import { LocalVolumeSetModel } from '../../models';
import { LocalVolumeSetKind, DeviceType, DiskMechanicalProperty } from './types';
    ...
    const requestData: LocalVolumeSetKind = {
      ...
      spec: {
        ...
        deviceInclusionSpec: {
          ...
          deviceMechanicalProperty: [DiskMechanicalProperty[state.diskType]],
        },
        nodeSelector: {
          nodeSelectorTerms: [
            {
  ...
  return (
    <>
      ...
      <Form noValidate={false} className="co-m-pane__body co-m-pane__form" onSubmit={onSubmit}>
        <LocalVolumeSetInner dispatch={dispatch} state={state} match={match.params} />
