...
export const storageClusterView =$('a[href="/k8s/ns/openshift-storage/operators.coreos.com~v1alpha1~ClusterServiceVersion/ocs-operator.v0.0.2/ocs.openshift.io~v1~StorageCluster"]');
