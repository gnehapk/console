...
export const NodeList: React.FC<NodeListProps> = (props) => {
  ...
  return (
    <Table
      ...
      Row={(nodeProps) => <NodeTableRow {...nodeProps} onSelect={props.onSingleSelect} />} // this is the correct select callback for single row
      aria-label="Nodes"
      virtualize
      onSelect={props.onSelectAll} // this is the selectAll callback for virtualized tables
    />
  );
};
