...
//const NodesList = props => <Table {...props} Header={NodeTableHeader} Rows={NodeTableRows} aria-label="Nodes" onSelect={console.log('hello')} virtualize={false}/>;
//const NodesList = props => <Table {...props} Header={NodeTableHeader} Rows={NodeTableRows} aria-label="Nodes" onSelect={console.log('hello')} virtualize={false}/>;
...
export const CreateOCSServiceForm: React.FC<CreateOCSServiceFormProps> = (props1) => {
  ...
  const NodesList = props => <Table {...props} Header={NodeTableHeader} Rows={NodeTableRows} aria-label="Nodes" onSelect={onSelect} virtualize={false}/>;
